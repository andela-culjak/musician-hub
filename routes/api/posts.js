...
//@route    DELETE api/post/multimedia/:trackid
//@desc     Delete music post by track id
//@access   Private
router.delete("/multimedia/:trackid", auth, async (req, res) => {
  try {
    const post = await Post.findOne({ trackId: req.params.trackid });
